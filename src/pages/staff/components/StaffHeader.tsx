...
import { ArrowLeft, Briefcase, Contact, UserCircle } from "lucide-react";
...
export const StaffHeader: React.FC<StaffHeaderProps> = ({ staff, onUpdateStaff }) => {
  ...
  // Use MediaViewerModal instead of a custom inline lightbox
  ...
  return (
    <>
        ...
        <div className={styles.headerLeft}>
          ...
          <div className={styles.headerInfo}>
            <div className={styles.headerTitleRow}>
              ...
              {/* Status badge via helper — replaces 3 repeated inline span blocks */}
      ...
      {/* Avatar Preview — now uses MediaViewerModal instead of a custom overlay */}
      <MediaViewerModal
