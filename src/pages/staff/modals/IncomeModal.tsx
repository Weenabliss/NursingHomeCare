...
import { Trash2, Plus, Wallet, Banknote, BadgeDollarSign, ShieldCheck, Check, X } from "lucide-react";
...
export const IncomeModal: React.FC<IncomeModalProps> = ({ staff, isOpen, onClose, isDirty, markDirty }) => {
  ...
  const { allowanceTypes, addAllowanceType } = usePayroll();
  ...
  // State cho inline form thêm loại trợ cấp mới
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.rightColumn}>
          <div className={styles.allowanceSection}>
            ...
            {/* Header: tiêu đề + 2 nút (Thêm loại mới [SUPER_ADMIN] + Thêm trợ cấp) */}
            <div className={styles.sectionHeader}>
              ...
              {isSuperAdmin && (
                <BaseButton
                  ...
                  title="Quản trị: Thêm loại trợ cấp mới vào danh sách"
                >
                  <ShieldCheck size={14} />
                  {showNewTypeForm ? " Huỷ" : " Loại mới"}
                </BaseButton>
              )}
            ...
            <div className={styles.allowanceBody}>
              ...
              {/* Inline form tạo loại trợ cấp mới – chỉ SUPER_ADMIN */}
                  ...
                  <div className={styles.newTypeFields}>
                    ...
                    <div className={styles.newTypeActions}>
                      ...
                      <button
                        ...
                        onClick={() => { setShowNewTypeForm(false); setNewTypeName(""); setNewTypeAmount(0); }}
                        title="Huỷ"
                      >
                        <X size={15} />
                      </button>
